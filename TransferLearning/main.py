...
参考pytorch英文原教程 - finetuning torchvision models
对多个pretrained模型进行transfer learning
...
基本变量指定
'''
path = '~/MyDatasets/Imagenet_2class/hymenoptera_data'
...
print('trainsets length: {}'.format(len(image_datasets['train'])))
print('trainloaders length: {}'.format(len(dataloaders_dict['train'])))
